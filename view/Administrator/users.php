...
<!-- Toast notification -->
<div id="globalToast" class="fixed top-6 right-6 z-60 hidden w-full max-w-md">
...
function showTopAlert(type, msg, duration = 5000) {
    ...
    // Use chip notification and force this page's container to top-right
    showChip(msg, type, 'admin-alert-chip', duration);
    const chipContainer = document.getElementById('admin-alert-chip');
    if (chipContainer) {
        chipContainer.className = 'fixed top-6 right-6 z-[9998] w-full max-w-md px-0';
        chipContainer.style.left = 'auto';
        chipContainer.style.transform = 'none';
    }
}
