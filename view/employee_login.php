  ...
  <div class="relative w-full max-w-sm">
    ...
    <div class="bg-white dark:bg-[#071127] rounded-xl shadow-2xl p-6 pt-14">
      ...
      <div class="text-center mb-6">
        <h1 class="text-xl sm:text-2xl font-bold text-[#1E3A8A] dark:text-yellow-400">Employee Portal</h1>
        <p class="text-sm font-normal text-gray-600 dark:text-gray-300">Welcome back! Please login to continue</p>
      </div>
