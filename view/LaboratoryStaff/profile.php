                    ...
                    <div class="border border-gray-200 rounded p-3">
                        <div class="flex items-center justify-between mb-2">
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500 mt-0.5">Manage your digital signature for documents</p>
                            </div>
                            <a href="e-signature.php" class="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white text-[10px] font-medium rounded transition-colors">
                                <i class="fa-solid fa-signature mr-1"></i>Manage Signature
                            </a>
                        </div>
                    </div>
