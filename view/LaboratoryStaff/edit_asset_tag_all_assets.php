    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Update asset tags for <?php echo count($assets); ?> selected asset(s)</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mt-6 p-4">
            <div class="flex items-center justify-between">
                ...
                <a href="allassets.php" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium">
