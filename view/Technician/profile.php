...
<main class="p-6 bg-gray-50 min-h-screen text-[11px] text-gray-700">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white rounded-lg border p-4 space-y-3">
                ...
                <div class="flex items-start gap-4 pb-3 border-b border-gray-200">
                    <div class="relative shrink-0">
                        <img src="../../assets/images/technician_profile.png" alt="Avatar"
                             class="w-20 h-20 rounded-full border border-gray-300 object-cover shadow-sm">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 text-[10px] text-gray-600 mt-1">
                            <span class="flex items-center gap-1">
                                <i class="fa-solid fa-screwdriver-wrench text-[#1E3A8A]"></i>
                                <?php echo htmlspecialchars($user_data['role'] ?? 'N/A'); ?>
                            </span>
                            <span class="text-gray-400">•</span>
                            <span><?php echo htmlspecialchars($user_data['id_number'] ?? 'N/A'); ?></span>
                        </div>
                        <p class="text-[10px] text-gray-500 mt-1 italic">Providing technical support and maintenance</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 text-[10px] text-gray-700">
                    ...
                    <div>
                        <p class="font-medium text-gray-600 mb-1">
                            <i class="fa-solid fa-phone text-[#1E3A8A] mr-1"></i> Phone Number
                        </p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo date('M j, Y g:i A', strtotime($user_data['last_login'] ?? 'now')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border p-4 space-y-3">
                <h3 class="text-sm font-semibold text-gray-800 flex items-center gap-2">
                    <i class="fa-solid fa-clock-rotate-left text-[#1E3A8A]"></i> Recent Login Activity
                </h3>
                <div class="space-y-2">
                    <div class="flex items-center justify-between py-2 border-b border-gray-100">
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-circle-dot text-green-500 text-[8px]"></i>
                            <span class="text-[10px] text-gray-700">Current Session</span>
                        </div>
                        <span class="text-[10px] text-gray-500"><?php echo date('M j, Y g:i A', strtotime($user_data['last_login'] ?? 'now')); ?></span>
                    </div>
                    <div class="flex items-center justify-between py-2 border-b border-gray-100">
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-circle text-gray-300 text-[8px]"></i>
                            <span class="text-[10px] text-gray-700">Previous Login</span>
                        </div>
                        <span class="text-[10px] text-gray-500">Nov 25, 2025 – 9:18 AM</span>
                    </div>
                    <div class="flex items-center justify-between py-2">
                        ...
                        <span class="text-[10px] text-gray-500">Nov 24, 2025 – 3:42 PM</span>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg border p-4 space-y-3">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-0.5 bg-green-100 text-green-700 rounded-full text-[10px] font-medium">Technical</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border p-4 space-y-3">
                <h3 class="text-sm font-semibold text-gray-800 flex items-center gap-2">
                    <i class="fa-solid fa-user-gear text-[#1E3A8A]"></i> Privileges
                </h3>
